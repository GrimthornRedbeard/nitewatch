...
var trustedSigners = map[string]bool{
	...
	// The identity Windows Defender's own binaries carry. Its absence meant
	// SecurityScanner could not recognise Defender at all, which is the whole
	// reason that suppression exists.
	"microsoft windows publisher":     true,
	"google llc":                      true,
	"google inc":                      true,
